...
export default async function LandlordPaymentsPage() {
  ...
  const payments = ownedIds.length > 0
  ...
  return (
    <div>
      <PageHeader title="Rental income" description="All payments received on your properties." />
      {list.length === 0 ? (
        <EmptyState icon={<Wallet className="size-8" />} title="No payments yet" description="Rent and deposit payments will appear here." />
      ) : (
        <Card>
